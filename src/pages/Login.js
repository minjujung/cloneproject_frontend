              ...
              >
                <DivM>
                  ...
                  <DivMC>
                    ...
                    <Tooltip
                      title="로그인할 때와 비밀번호를 재설정해야할 때 사용하는 정보입니다."
                      arrow
                    >
                      <InputEmail
                        signUpInfo={signupInfo}
                    ...
                    <Tooltip
                      title="숫자, 영문, 특수기호(!,& 등)를 조합한 여섯 자리 이상의 비밀번호를 입력하세요."
                      arrow
                    >
                      <InputPwd
                        signUpInfo={signupInfo}
                    ...
                    <div>
                      {is_uploading ? (
                        ...
                        <div>
                          <DivPicture>
                            <Tooltip
                              title="아래에 카메라 버튼을 클릭하여 프로필 사진을 선택하세요."
                              placement="left"
                            >
